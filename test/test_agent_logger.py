#!/usr/bin/env python3
"""
Test script for AgentLogger and LogDirectoryManager
Tests various scenarios to identify issues with logger names and log directory management
"""
...
def test_logger_name_issue():
    """Test 1: Check if logger names are properly handled"""
    print("=" * 60)
    print("Test 1: Logger Name Issue")
    print("=" * 60)
    ...
    try:
        ...
        # Check if they are the same instance (singleton)
        ...
        if log_file.exists():
            print(f"\nLog file content from {log_file.name}:")
...
def test_log_directory_manager():
    """Test 2: Check if log directory manager works properly"""
    print("\n" + "=" * 60)
    print("Test 2: Log Directory Manager")
    print("=" * 60)
...
def test_multiple_loggers_same_name():
    """Test 3: Test multiple loggers with same name"""
    print("\n" + "=" * 60)
    print("Test 3: Multiple Loggers with Same Name")
    print("=" * 60)
...
def test_logger_after_directory_change():
    """Test 4: Test logger behavior after directory change"""
    print("\n" + "=" * 60)
    print("Test 4: Logger After Directory Change")
    print("=" * 60)
    ...
    try:
        ...
        # Change directory
        set_agent_log_directory(temp_dir2)
        logger.info("Message after directory change - where should this go?")
...
def test_environment_variable_behavior():
    """Test 5: Test environment variable behavior"""
    print("\n" + "=" * 60)
    print("Test 5: Environment Variable Behavior")
    print("=" * 60)
...
def main():
    """Run all tests"""
    print("Starting AgentLogger and LogDirectoryManager Tests")
    print("=" * 80)
    
    test_logger_name_issue()
    test_log_directory_manager()
    test_multiple_loggers_same_name()
    test_logger_after_directory_change()
    test_environment_variable_behavior()
