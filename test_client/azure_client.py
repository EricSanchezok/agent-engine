...
class AzureClient(LLMClient):
    ...
    def __init__(self, api_key: str, base_url: str = 'https://gpt.yunstorm.com/', api_version: str = '2025-04-01-preview'):
        ...
        print(f"✅ AzureClient initialized with endpoint: {self.base_url}")
    
    async def close(self):
        """Close the Azure OpenAI client connection"""
        if self.client:
            await self.client.close()
            print("✅ AzureClient connection closed")
    ...
    async def call_llm(
        ...
        **kwargs
        ...
        print(f"🚀 Requesting Azure OpenAI: model={model_name}, max_tokens={max_tokens}")
        ...
        try:
            ...
            print(f"❌ Failed to call Azure OpenAI after all retries: {e}")
            return None
    ...
    async def get_embeddings(
        ...
        **kwargs
        ...
        print(f"🚀 Requesting Azure OpenAI embeddings: model={model_name}")
        ...
        try:
            ...
            print(f"✅ Azure OpenAI embeddings received successfully")
            return embeddings
            
        except Exception as e:
            print(f"❌ Failed to get embeddings after all retries: {e}")
            return None
